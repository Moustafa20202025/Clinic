        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredRays = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorPatientSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorPatientSchedules_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorPatientSchedules_Patients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DosageDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicEmployees", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClinicStores_Clinics_ClinicId",
                        column: x => x.ClinicId,
                        principalTable: "Clinics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClinicEmployeeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryEmployee_ClinicEmployees_ClinicEmployeeId",
                        column: x => x.ClinicEmployeeId,
                        principalTable: "ClinicEmployees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicStores_ClinicId",
                table: "ClinicStores",
                column: "ClinicId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorPatientSchedules_DoctorId",
                table: "DoctorPatientSchedules",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorPatientSchedules_PatientId",
                table: "DoctorPatientSchedules",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryEmployee_ClinicEmployeeId",
                table: "SalaryEmployee",
                column: "ClinicEmployeeId");
        }
